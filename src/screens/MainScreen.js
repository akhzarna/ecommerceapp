...
function MainScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      setProductsDetails(storage.getItem('products'));
      console.log(data.length, "in fetch");
    } catch (error) {
