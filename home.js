...
<Image source={{uri:item.image}} style={{height:100,width:100,marginTop:20}} />
                    ...
                    <TouchableOpacity style={{width:50, height:25, backgroundColor:clr, alignItems:'center',justifyContent:'center',borderRadius:10}}
    ...
    onPress={() =>
      navigation.navigate('bookmark',books)
          ...
          >
        <Text style={{fontWeight:"bold",color:"white"}}>BOOKMARK'S</Text>
